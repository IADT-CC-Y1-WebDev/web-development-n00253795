...
startSession();
//change all to what its supposed to be
...
try {
    ...
    $bookFormats = Format::findByBook($book->id); //bookFormats!!!!!!
    $bookFormatsIds = [];
            ...
            <div class="width-12">
                <form action="book_update.php" method="POST" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="input">
                        ...
                        <div>
                            <input type="author" id="author" name="author" value="<?= old('author', $book->author) ?>" required>
                            <p><?= error('author') ?></p>
                        </div>
                    </div>
                    <div class="input">
